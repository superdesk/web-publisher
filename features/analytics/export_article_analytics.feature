...
#    And the CSV file "/public/uploads/swp/123456/exports/analytics-2019-03-10-10:00:00.csv" should contain 3 rows
    ...
    Given the current date time is "2019-03-10 19:00"
    Given I am authenticated as "test.user"
    When I add "Content-Type" header equal to "application/json"
    And I send a "POST" request to "/api/v2/export/analytics/" with body:
    """
    ...
    """
    {
       ...
       "_embedded":{
          "_items":[
             ...
             {
                "id":4,
                "asset_id":"analytics-2019-03-10-12:00:00.csv",
                "user":{
                   "id":1,
                   "username":"test.user",
                   "email":"test.user@sourcefabric.org",
                ...
                "created_at":"2019-03-10T12:00:00+00:00",
                "updated_at":"2019-03-10T12:00:00+00:00",
                "_links":{
                   "download":{
                      "href":"http://localhost/analytics/export/analytics-2019-03-10-12:00:00.csv"
                   }
                }
             },
             {
                "id":5,
                "asset_id":"analytics-2019-03-10-13:00:00.csv",
                "user":{
                   "id":1,
                   "username":"test.user",
                   "email":"test.user@sourcefabric.org",
                ...
                "created_at":"2019-03-10T13:00:00+00:00",
                "updated_at":"2019-03-10T13:00:00+00:00",
                "_links":{
                   "download":{
                      "href":"http://localhost/analytics/export/analytics-2019-03-10-13:00:00.csv"
                   }
                }
             },
             {
                "id":6,
                "asset_id":"analytics-2019-03-10-14:00:00.csv",
                "user":{
                   "id":1,
                   "username":"test.user",
                   "email":"test.user@sourcefabric.org",
                ...
                "created_at":"2019-03-10T14:00:00+00:00",
                "updated_at":"2019-03-10T14:00:00+00:00",
                "_links":{
                   "download":{
                      "href":"http://localhost/analytics/export/analytics-2019-03-10-14:00:00.csv"
                   }
                }
             },
             {
                "id":7,
                "asset_id":"analytics-2019-03-10-15:00:00.csv",
                "user":{
                   "id":1,
                   "username":"test.user",
                   "email":"test.user@sourcefabric.org",
                ...
                "created_at":"2019-03-10T15:00:00+00:00",
                "updated_at":"2019-03-10T15:00:00+00:00",
                "_links":{
                   "download":{
                      "href":"http://localhost/analytics/export/analytics-2019-03-10-15:00:00.csv"
                   }
                }
             },
             {
                "id":8,
                "asset_id":"analytics-2019-03-10-19:00:00.csv",
                "user":{
                   "id":1,
                   "username":"test.user",
                   "email":"test.user@sourcefabric.org",
                ...
                "created_at":"2019-03-10T19:00:00+00:00",
                "updated_at":"2019-03-10T19:00:00+00:00",
                "_links":{
                   "download":{
                      "href":"http://localhost/analytics/export/analytics-2019-03-10-19:00:00.csv"
                   }
                }
             }
          ]
