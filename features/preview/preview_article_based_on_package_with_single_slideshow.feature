@preview
Feature: Preview article under route based on package data with a single slideshow

  Scenario: Preview article with a single slideshow
     ...
     """
      {
        "route": {
          ...
          "type": "collection",
          "articlesTemplateName": "article_single_slideshow.html.twig"
        }
      }
    """
          ...
          "items":[
            {
              "renditions":{
                "16-9":{
                  ...
                  "mimetype":"image/jpeg",
                  "width":1079,
                  "media":"21234567890987654321a",
                  "href":"http://localhost:5000/api/upload/21234567890987654321a/raw?_schema=http"
                },
                "4-3":{
                  "height":533,
                  "mimetype":"image/jpeg",
                  "width":800,
                  "media":"21234567890987654321b",
                  "href":"http://localhost:5000/api/upload/21234567890987654321b/raw?_schema=http"
                },
                "original":{
                  "height":2667,
                  "mimetype":"image/jpeg",
                  "width":4000,
                  "media":"21234567890987654321c",
                  "href":"http://localhost:5000/api/upload/21234567890987654321c/raw?_schema=http"
                }
              },
              "urgency":3,
              "body_text":"test image",
            ...
            },
            {
              "renditions":{
                "16-9":{
                  ...
                  "width":1079,
                  "media":"2234567890987654321a",
                  "href":"http://localhost:5000/api/upload/22234567890987654321a/raw?_schema=http"
                },
                "4-3":{
                  "height":533,
                  "mimetype":"image/jpeg",
                  "width":800,
                  "media":"2234567890987654321b",
                  "href":"http://localhost:5000/api/upload/22234567890987654321b/raw?_schema=http"
                },
                "original":{
                  "height":2667,
                  "mimetype":"image/jpeg",
                  "width":4000,
                  "media":"2234567890987654321c",
                  "href":"http://localhost:5000/api/upload/22234567890987654321c/raw?_schema=http"
                }
              },
              "urgency":3,
              "body_text":"test image",
              "versioncreated":"2016-08-17T17:46:52+0000",
              "guid":"tag:localhost:2016:56753145-8d59-4eed-bdd5-387013db97a1",
              "byline":"Pawe\u0142 Miko\u0142ajczuk",
              "pubstatus":"usable",
              "language":"en",
              "version":"2",
    ...
    And the response should not contain "slideshow2"
