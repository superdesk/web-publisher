...
Feature: Making sure that the "body" HTML tag is not added to article's body
  ...
  Scenario: Send content with embedded image in media-block format
    ...
    """
    {"id":6,"title":"test image in body","body":"<p>test image in body<\/p><!-- EMBED START Image {id: \"editor_0\"} --><figure><img src=\"\/media\/20161206161256_383592fef7acb9fc4731a24a691285b7bc51477264a5e343d95c74ccf1d85a93a.jpeg\" data-media-id=\"editor_0\" data-image-id=\"20161206161256_383592fef7acb9fc4731a24a691285b7bc51477264a5e343d95c74ccf1d85a93a\" data-rendition-name=\"original\" width=\"2048\" height=\"1365\" alt=\"Review Bombing\"><figcaption>Review Bombing<span><\/span><\/figcaption><\/figure><!-- EMBED END Image {id: \"editor_0\"} --><p>new line<\/p>","slug":"test-image-in-body","status":"new","route":{"requirements":{"slug":"[a-zA-Z0-9*\\-_]+"},"id":3,"staticPrefix":"\/news","variablePattern":"\/{slug}","children":[{"requirements":{"slug":"[a-zA-Z0-9*\\-_]+"},"id":6,"staticPrefix":"\/news\/sports","variablePattern":"\/{slug}","parent":3,"children":[],"lft":4,"rgt":5,"level":1,"type":"collection","cacheTimeInSeconds":0,"name":"sports","slug":"sports","position":0,"articlesCount":0,"paywallSecured":false,"_links":{"self":{"href":"\/api\/v1\/content\/routes\/6"},"parent":{"href":"\/api\/v1\/content\/routes\/3"}}}],"lft":3,"rgt":6,"level":0,"type":"collection","cacheTimeInSeconds":0,"name":"news","slug":"news","position":1,"articlesCount":0,"paywallSecured":false,"_links":{"self":{"href":"\/api\/v1\/content\/routes\/3"}}},"isPublishable":false,"metadata":{"subject":[],"urgency":0,"priority":5,"place":[],"service":[{"code":"b","name":"Business"}],"type":"text","byline":"test embedded image in body","guid":"urn:newsml:spsd.pro:2018-09-04T13:30:12.108807:89f823eb-6a6f-4ec9-ac09-06f5b95695d6","language":"en"},"media":[],"lead":"test image in body","code":"urn:newsml:spsd.pro:2018-09-04T13:30:12.108807:89f823eb-6a6f-4ec9-ac09-06f5b95695d6","sources":[],"extra":[],"slideshows":[],"createdAt":"2019-03-10T09:00:00+00:00","updatedAt":"2019-03-10T09:00:00+00:00","authors":[{"name":"Admin Person","role":"featured","jobtitle":[],"biography":"","id":6,"slug":"admin-person"}],"keywords":[],"isPublishedFBIA":false,"articleStatistics":{"impressionsNumber":0,"pageViewsNumber":0,"internalClickRate":0,"createdAt":"2019-03-10T09:00:00+00:00","updatedAt":"2019-03-10T09:00:00+00:00"},"commentsCount":0,"tenant":{"id":1,"domainName":"localhost","code":"123abc","name":"Default tenant","ampEnabled":true,"fbiaEnabled":false,"paywallEnabled":false,"_links":{"self":{"href":"\/api\/v1\/tenants\/123abc"}}},"paywallSecured":false,"contentLists":[],"_links":{"self":{"href":"\/api\/v1\/content\/articles\/test-image-in-body"},"online":{"href":"\/news\/test-image-in-body"},"related":{"href":"\/api\/v1\/content\/articles\/6\/related\/"},"slideshows":{"href":"\/api\/v1\/content\/slideshows\/6"}}}
    """
