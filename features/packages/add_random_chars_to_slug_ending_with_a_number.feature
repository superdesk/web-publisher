@packages
Feature: Send package with slug ending with -{numbers} and make sure that it's processed

  Scenario: Create rules for tenant and publish send package
