...
/**
 * @mixin RegisterPHPCRArticleFactoryPass
 */
class RegisterPHPCRArticleFactoryPassSpec extends ObjectBehavior
{
    public function it_is_initializable()
    {
        $this->shouldHaveType(RegisterPHPCRArticleFactoryPass::class);
    }
    ...
    public function it_creates_a_default_definition_of_article_factory(
        ...
        $container->hasParameter('swp_content.backend_type_phpcr')->willReturn(true);
