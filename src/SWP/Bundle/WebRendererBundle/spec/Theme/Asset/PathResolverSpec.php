 ...
 */
namespace spec\SWP\Bundle\WebRendererBundle\Theme\Asset;

use PhpSpec\ObjectBehavior;
use SWP\Bundle\WebRendererBundle\Theme\Asset\PathResolver;
...
class PathResolverSpec extends ObjectBehavior
{
    ...
    function it_returns_modified_path_if_its_referencing_asset(ThemeInterface $theme)
    {
        $theme->getName()->willReturn('theme/name');
        $this->resolve('theme/asset.min.js', $theme)->shouldReturn('bundles/_themes/theme/name/asset.min.js');
    }

    function it_does_not_change_path_if_its_not_referencing_asset(ThemeInterface $theme)
    {
