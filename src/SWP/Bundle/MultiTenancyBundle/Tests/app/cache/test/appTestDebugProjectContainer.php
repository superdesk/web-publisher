...
class appTestDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'swp_multi_tenancy.path_builder' => 'getSwpMultiTenancy_PathBuilderService',
            'swp_multi_tenancy.phpcr.generic_initializer' => 'getSwpMultiTenancy_Phpcr_GenericInitializerService',
            'swp_multi_tenancy.phpcr.initializer' => 'getSwpMultiTenancy_Phpcr_InitializerService',
            'swp_multi_tenancy.tenant_aware_router' => 'getSwpMultiTenancy_TenantAwareRouterService',
            'swp_multi_tenancy.tenant_context' => 'getSwpMultiTenancy_TenantContextService',
            'swp_multi_tenancy.tenant_listener' => 'getSwpMultiTenancy_TenantListenerService',
            'swp_multi_tenancy.tenant_provider' => 'getSwpMultiTenancy_TenantProviderService',
            'swp_multi_tenancy.tenant_repository' => 'getSwpMultiTenancy_TenantRepositoryService',
            'swp_multi_tenancy.tenant_resolver' => 'getSwpMultiTenancy_TenantResolverService',
            'swp_multi_tenancy.tenant_subscriber' => 'getSwpMultiTenancy_TenantSubscriberService',
    ...
    protected function getDebug_EventDispatcherService()
    {
        ...
        $instance->addListenerService('kernel.request', array(0 => 'swp_multi_tenancy.tenant_listener', 1 => 'onKernelRequest'), 31);
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $b->addLogger(new \Symfony\Bridge\Doctrine\Logger\DbalLogger(NULL, $this->get('debug.stopwatch', ContainerInterface::NULL_ON_INVALID_REFERENCE)));
        ...
        $f->addEventSubscriber($this->get('swp_multi_tenancy.tenant_subscriber'));

        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_sqlite', 'path' => (__DIR__.'/test.db3'), 'host' => 'localhost', 'port' => NULL, 'user' => 'root', 'password' => NULL, 'driverOptions' => array(), 'defaultTableOptions' => array()), $c, $f, array());
    }
    ...
    {
        $a = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array(($this->targetDirs[2].'/Resources/doctrine') => 'SWP\\Component\\MultiTenancy\\Model\\Tenant'));
        $a->setGlobalBasename('mapping');

        $b = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $b->addDriver($a, 'SWP\\Component\\MultiTenancy\\Model\\Tenant');
        $b->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[4].'/vendor/gedmo/doctrine-extensions/lib/Gedmo/Loggable/Entity'))), 'Gedmo\\Loggable\\Entity');

        $c = new \Doctrine\ORM\Configuration();
        $c->setEntityNamespaces(array('SWPMultiTenancyBundle' => 'SWP\\Component\\MultiTenancy\\Model\\Tenant', 'gedmo_loggable' => 'Gedmo\\Loggable\\Entity'));
        ...
        $c->addFilter('tenantable', 'SWP\\MultiTenancyBundle\\Query\\Filter\\TenantableFilter');
    ...
    {
        return $this->services['doctrine.orm.default_manager_configurator'] = new \Doctrine\Bundle\DoctrineBundle\ManagerConfigurator(array(0 => 'soft_deleteable', 1 => 'tenantable'), array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_46b71cad7aa3f65d4a255269c3ef3d67ada989c383217291c93b6e36dd3deccf');
    ...
    {
        return $this->services['stof_doctrine_extensions.event_listener.logger'] = new \Stof\DoctrineExtensionsBundle\EventListener\LoggerListener($this->get('stof_doctrine_extensions.listener.loggable'));
    }
    ...
    /**
     * Gets the 'swp_multi_tenancy.path_builder' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \SWP\Component\MultiTenancy\PathBuilder\TenantAwarePathBuilder A SWP\Component\MultiTenancy\PathBuilder\TenantAwarePathBuilder instance.
     */
    protected function getSwpMultiTenancy_PathBuilderService()
    {
        return $this->services['swp_multi_tenancy.path_builder'] = new \SWP\Component\MultiTenancy\PathBuilder\TenantAwarePathBuilder($this->get('swp_multi_tenancy.tenant_context'), '/swp');
    }

    /**
     * Gets the 'swp_multi_tenancy.phpcr.generic_initializer' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getSwpMultiTenancy_Phpcr_GenericInitializerService()
    {
        return $this->services['swp_multi_tenancy.phpcr.generic_initializer'] = new \Doctrine\Bundle\PHPCRBundle\Initializer\GenericInitializer('Default initializer', array(0 => '/swp'));
    }

    /**
     * Gets the 'swp_multi_tenancy.phpcr.initializer' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \SWP\Bundle\MultiTenancyBundle\Initializer\PHPCRBasePathsInitializer A SWP\Bundle\MultiTenancyBundle\Initializer\PHPCRBasePathsInitializer instance.
     */
    protected function getSwpMultiTenancy_Phpcr_InitializerService()
    {
        return $this->services['swp_multi_tenancy.phpcr.initializer'] = new \SWP\Bundle\MultiTenancyBundle\Initializer\PHPCRBasePathsInitializer(array(0 => 'routes', 1 => 'content'), $this->get('swp_multi_tenancy.tenant_provider'), $this->get('swp_multi_tenancy.path_builder'), 'SWP\\MultiTenancyBundle\\Document\\Site');
    }

    /**
     * Gets the 'swp_multi_tenancy.tenant_aware_router' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \SWP\Bundle\MultiTenancyBundle\Routing\TenantAwareRouter A SWP\Bundle\MultiTenancyBundle\Routing\TenantAwareRouter instance.
     */
    protected function getSwpMultiTenancy_TenantAwareRouterService()
    {
        return $this->services['swp_multi_tenancy.tenant_aware_router'] = new \SWP\Bundle\MultiTenancyBundle\Routing\TenantAwareRouter();
    }

    /**
     * Gets the 'swp_multi_tenancy.tenant_context' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \SWP\Bundle\MultiTenancyBundle\Context\TenantContext A SWP\Bundle\MultiTenancyBundle\Context\TenantContext instance.
     */
    protected function getSwpMultiTenancy_TenantContextService()
    {
        return $this->services['swp_multi_tenancy.tenant_context'] = new \SWP\Bundle\MultiTenancyBundle\Context\TenantContext($this->get('swp_multi_tenancy.tenant_resolver'), $this->get('request_stack'));
    }

    /**
     * Gets the 'swp_multi_tenancy.tenant_listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \SWP\Bundle\MultiTenancyBundle\EventListener\TenantableListener A SWP\Bundle\MultiTenancyBundle\EventListener\TenantableListener instance.
     */
    protected function getSwpMultiTenancy_TenantListenerService()
    {
        return $this->services['swp_multi_tenancy.tenant_listener'] = new \SWP\Bundle\MultiTenancyBundle\EventListener\TenantableListener($this->get('doctrine.orm.default_entity_manager'), $this->get('swp_multi_tenancy.tenant_context'), $this->get('swp_multi_tenancy.tenant_resolver'));
    }

    /**
     * Gets the 'swp_multi_tenancy.tenant_provider' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \SWP\Component\MultiTenancy\Provider\TenantProvider A SWP\Component\MultiTenancy\Provider\TenantProvider instance.
     */
    protected function getSwpMultiTenancy_TenantProviderService()
    {
        return $this->services['swp_multi_tenancy.tenant_provider'] = new \SWP\Component\MultiTenancy\Provider\TenantProvider($this->get('swp_multi_tenancy.tenant_repository'));
    }

    /**
     * Gets the 'swp_multi_tenancy.tenant_repository' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getSwpMultiTenancy_TenantRepositoryService()
    {
        return $this->services['swp_multi_tenancy.tenant_repository'] = $this->get('doctrine.orm.default_entity_manager')->getRepository('SWP\\Component\\MultiTenancy\\Model\\Tenant');
    }

    /**
     * Gets the 'swp_multi_tenancy.tenant_resolver' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \SWP\Component\MultiTenancy\Resolver\TenantResolver A SWP\Component\MultiTenancy\Resolver\TenantResolver instance.
     */
    protected function getSwpMultiTenancy_TenantResolverService()
    {
        return $this->services['swp_multi_tenancy.tenant_resolver'] = new \SWP\Component\MultiTenancy\Resolver\TenantResolver('example.com', $this->get('swp_multi_tenancy.tenant_repository'));
    }

    /**
     * Gets the 'swp_multi_tenancy.tenant_subscriber' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \SWP\Bundle\MultiTenancyBundle\EventListener\TenantSubscriber A SWP\Bundle\MultiTenancyBundle\EventListener\TenantSubscriber instance.
     */
    protected function getSwpMultiTenancy_TenantSubscriberService()
    {
        return $this->services['swp_multi_tenancy.tenant_subscriber'] = new \SWP\Bundle\MultiTenancyBundle\EventListener\TenantSubscriber($this);
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'SWPMultiTenancyBundle' => 'SWP\\MultiTenancyBundle\\SWPMultiTenancyBundle',
            ),
            ...
            'swp_multi_tenancy.persistence.phpcr.basepath' => '/swp',
            'swp_multi_tenancy.persistence.phpcr.route_basepaths' => array(
                0 => 'routes',
            ),
            'swp_multi_tenancy.persistence.phpcr.content_basepath' => 'content',
            'swp_multi_tenancy.persistence.phpcr.site_document.class' => 'SWP\\MultiTenancyBundle\\Document\\Site',
            'swp_multi_tenancy.persistence.phpcr.router.class' => 'SWP\\MultiTenancyBundle\\Routing\\TenantAwareRouter',
            'swp_multi_tenancy.persistence.phpcr.base_paths' => array(
                0 => 'routes',
                1 => 'content',
            ),
            'swp_multi_tenancy.path_builder.class' => 'SWP\\Component\\MultiTenancy\\PathBuilder\\TenantAwarePathBuilder',
            'swp_multi_tenancy.prefix_candidates.class' => 'SWP\\MultiTenancyBundle\\Doctrine\\PHPCR\\PrefixCandidates',
