...
class ResettingController extends AbstractController
{
    ...
    {
        return $this->render('@SWPUser/Resetting/request.html.twig');
    }
    ...
    public function sendEmailAction(Request $request)
    {
        ...
        $this->eventDispatcher->dispatch($event, SWPUserEvents::RESETTING_SEND_EMAIL_INITIALIZE);
        ...
        if (null !== $user && !$user->isPasswordRequestNonExpired($this->retryTtl)) {
            ...
            $this->eventDispatcher->dispatch($event, SWPUserEvents::RESETTING_RESET_REQUEST);
            ...
            $event = new GetResponseUserEvent($user, $request);
            $this->eventDispatcher->dispatch($event, SWPUserEvents::RESETTING_SEND_EMAIL_CONFIRM);
            ...
            $event = new GetResponseUserEvent($user, $request);
            $this->eventDispatcher->dispatch($event, SWPUserEvents::RESETTING_SEND_EMAIL_COMPLETED);
    ...
    public function resetAction(Request $request, $token)
    {
        ...
        $event = new GetResponseUserEvent($user, $request);
        $this->eventDispatcher->dispatch($event, SWPUserEvents::RESETTING_RESET_INITIALIZE);
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $this->eventDispatcher->dispatch($event, SWPUserEvents::RESETTING_RESET_SUCCESS);
        ...
        return $this->render('@SWPUser/Resetting/reset.html.twig', [
            'token' => $token,
