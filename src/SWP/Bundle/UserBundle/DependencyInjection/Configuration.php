...
use SWP\Bundle\UserBundle\Form\Type\ChangePasswordFormType;
use SWP\Bundle\UserBundle\Form\Type\ProfileFormType;
use SWP\Bundle\UserBundle\Form\Type\RegistrationFormType;
use SWP\Bundle\UserBundle\Form\Type\ResettingFormType;
                    ...
                    ->children()
                        ->arrayNode('form')
                            ...
                            ->children()
                                ...
                                ->scalarNode('name')->defaultValue('swp_user_profile_form')->end()
                ...
                ->arrayNode('resetting')
                    ...
                    ->children()
                        ...
                        ->arrayNode('email')
                            ->addDefaultsIfNotSet()
                            ->children()
                                ->scalarNode('template')->defaultValue('@SWPUser/Resetting/email.txt.twig')->end()
                                ->arrayNode('from_email')
                                    ->canBeUnset()
                                    ->children()
                                        ->scalarNode('address')->isRequired()->cannotBeEmpty()->end()
                        ...
                        ->arrayNode('form')
                            ...
                            ->children()
                                ...
                                ->scalarNode('name')->defaultValue('swp_user_resetting_form')->end()
                                ->arrayNode('validation_groups')
                                    ->prototype('scalar')->end()
                ...
                ->arrayNode('change_password')
                    ...
                    ->children()
                        ...
                        ->children()
                            ...
                            ->scalarNode('name')->defaultValue('swp_user_change_password_form')->end()
                            ->arrayNode('validation_groups')
                                ->prototype('scalar')->end()
        ...
        $node
            ...
            ->children()
                ->arrayNode('service')
                    ->addDefaultsIfNotSet()
                    ->children()
                        ->scalarNode('mailer')->defaultValue('swp_user.mailer.default')->end()
                        ->scalarNode('email_canonicalizer')->defaultValue('swp_user.util.canonicalizer.default')->end()
                        ->scalarNode('token_generator')->defaultValue('swp_user.util.token_generator.default')->end()
                        ->scalarNode('username_canonicalizer')->defaultValue('swp_user.util.canonicalizer.default')->end()
                        ->scalarNode('user_manager')->defaultValue('swp_user.user_manager.default')->end()
                    ->end()
                ->end()
            ->end()->end();
    }
