...
class SlideshowItemLoaderTest extends WebTestCase
{
    ...
    public function testLoadAllArticleSlideshowsItems(): void
    {
        ...
        self::assertEquals(' slideshow1-http://localhost/media/123456.mp4  slideshow1-http://localhost/media/12345678987654321a.jpeg  slideshow3-http://localhost/media/12345678987654321a.jpeg ', $result);
    }
    ...
    public function testLoadSlideshowItemsBySlideshowAndCurrentArticle(): void
    {
        ...
        self::assertEquals('slideshow1-http://localhost/media/123456.mp4slideshow1-http://localhost/media/12345678987654321a.jpeg', $result);
