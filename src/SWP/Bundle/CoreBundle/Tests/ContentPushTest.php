...
final class ContentPushTest extends WebTestCase
{
    ...
    public function testArticleUpdates()
    {
        ...
        self::assertEquals('test headline', $content1['title']);
    ...
    public function testItemWithFeatureMedia()
    {
        ...
        self::assertContains('<figure><img src="/media/20161206171212_896bd89c2eaa29bbb8a953787a86615c5a9aaf16b4ad93b4ac7f7af23f0c459c.jpeg"', $content);
