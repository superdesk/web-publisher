...
class OrganizationControllerTest extends WebTestCase
{
    ...
    public function testGetArticlesByOrganization()
    {
        ...
        self::assertArraySubset(json_decode('{"page":1,"limit":10,"pages":1,"total":2,"_links":{"self":{"href":"\/api\/v1\/organization\/articles\/?page=1&limit=10"},"first":{"href":"\/api\/v1\/organization\/articles\/?page=1&limit=10"},"last":{"href":"\/api\/v1\/organization\/articles\/?page=1&limit=10"}},"_embedded":{"_items":[{"id":1,"title":"art1","body":"art1 body","slug":"art1","publishedAt":null,"status":"new","route":null,"templateName":null,"publishStartDate":null,"publishEndDate":null,"isPublishable":false,"metadata":[],"media":[],"featureMedia":null,"lead":"art1 lead","keywords":[],"code":"12356yjgktowud","tenant":null,"_links":{"self":{"href":"\/api\/v1\/content\/articles\/art1"},"online":[{"href":"\/api\/v1\/content\/articles\/?slug=art1"},{"href":"\/api\/v1\/content\/articles\/"}]}},{"id":2,"title":"art2","body":"art2 body","slug":"art2","publishedAt":null,"status":"new","route":null,"templateName":null,"publishStartDate":null,"publishEndDate":null,"isPublishable":false,"metadata":[],"media":[],"featureMedia":null,"lead":"art2 lead","keywords":[],"code":"87346yjgktowrt","tenant":null,"_links":{"self":{"href":"\/api\/v1\/content\/articles\/art2"},"online":[{"href":"\/api\/v1\/content\/articles\/?slug=art2"},{"href":"\/api\/v1\/content\/articles\/"}]}}]}}', true), $content);
    }
