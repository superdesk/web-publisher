...
class ContentControllerTest extends WebTestCase
{
    ...
    public function testTestLoadingRouteWithCustomTemplate()
    {
        ...
        $this->assertEquals('{"id":3,"content":null,"staticPrefix":"\/simple-test-route","variablePattern":null,"parent":null,"children":[],"level":0,"templateName":"test.html.twig","articlesTemplateName":null,"type":"content","cacheTimeInSeconds":0,"name":"simple-test-route","position":null,"_links":{"self":{"href":"\/api\/v1\/content\/routes\/3"}}}', $client->getResponse()->getContent());
