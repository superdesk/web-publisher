...
class TenantControllerTest extends WebTestCase
{
    ...
    public function testCreateNewTenantWithDefaultOrganization()
    {
        ...
        $this->assertArraySubset(json_decode(
            '{"id":3,"subdomain":"test","name":"Test Tenant","organization":{"id":3,"name":"default"},"enabled":true,"theme_name":"swp\/test-theme"}', true
        ), json_decode(
    ...
    public function testCreateNewTenantWithCustomOrganization()
    {
        ...
        $this->assertEquals(201, $client->getResponse()->getStatusCode());
        $this->assertArraySubset(json_decode(
            '{"id":3,"subdomain":"test","name":"Test Tenant","organization":{"id":1,"name":"Organization1","code":"123456"},"enabled":true,"theme_name":"swp\/test-theme"}', true
        ), json_decode(
            $client->getResponse()->getContent(),
            true
        ));
    ...
    public function testUpdateTenant()
    {
        ...
        $this->assertArraySubset(json_decode(
            '{"subdomain":"updated test subdomain","name":"Updated tenant name","organization":{"id":3,"name":"default"},"enabled":true,"theme_name":"swp\/test-theme"}', true),
