...
class ContentListItemControllerTest extends WebTestCase
{
    ...
    public function testListingContentListsItemsApi()
    {
        ...
        self::assertArraySubset(json_decode('{"page":1,"limit":10,"pages":1,"total":4,"_links":{"self":{"href":"\/api\/v1\/content\/lists\/1\/items\/?page=1&limit=10"},"first":{"href":"\/api\/v1\/content\/lists\/1\/items\/?page=1&limit=10"},"last":{"href":"\/api\/v1\/content\/lists\/1\/items\/?page=1&limit=10"}},"_embedded":{"_items":[{"id":1,"content":{"id":1,"title":"article1","body":"art1","slug":"article-1","publishedAt":null,"status":"published","route":null,"templateName":null,"publishStartDate":null,"publishEndDate":null,"isPublishable":true,"metadata":null,"media":[],"lead":null,"_links":{"self":{"href":"\/api\/v1\/content\/articles\/article-1"},"online":[{"href":"\/api\/v1\/content\/articles\/?slug=article-1"},{"href":"\/api\/v1\/content\/articles\/"}]}},"position":0,"sticky":true,"enabled":true,"_links":{"list":{"href":"\/api\/v1\/content\/lists\/1"},"item":{"href":"\/api\/v1\/content\/lists\/1\/items\/1"}}},{"id":3,"content":{"id":3,"title":"article3","body":"art3","slug":"article-3","publishedAt":null,"status":"published","route":null,"templateName":null,"publishStartDate":null,"publishEndDate":null,"isPublishable":true,"metadata":null,"media":[],"lead":null,"_links":{"self":{"href":"\/api\/v1\/content\/articles\/article-3"},"online":[{"href":"\/api\/v1\/content\/articles\/?slug=article-3"},{"href":"\/api\/v1\/content\/articles\/"}]}},"position":2,"sticky":true,"enabled":true,"_links":{"list":{"href":"\/api\/v1\/content\/lists\/1"},"item":{"href":"\/api\/v1\/content\/lists\/1\/items\/3"}}},{"id":2,"content":{"id":2,"title":"article2","body":"art2","slug":"article-2","publishedAt":null,"status":"published","route":null,"templateName":null,"publishStartDate":null,"publishEndDate":null,"isPublishable":true,"metadata":null,"media":[],"lead":null,"_links":{"self":{"href":"\/api\/v1\/content\/articles\/article-2"},"online":[{"href":"\/api\/v1\/content\/articles\/?slug=article-2"},{"href":"\/api\/v1\/content\/articles\/"}]}},"position":1,"sticky":false,"enabled":true,"_links":{"list":{"href":"\/api\/v1\/content\/lists\/1"},"item":{"href":"\/api\/v1\/content\/lists\/1\/items\/2"}}},{"id":4,"content":{"id":4,"title":"article4","body":"art4","slug":"article-4","publishedAt":null,"status":"published","route":null,"templateName":null,"publishStartDate":null,"publishEndDate":null,"isPublishable":true,"metadata":null,"media":[],"lead":null,"_links":{"self":{"href":"\/api\/v1\/content\/articles\/article-4"},"online":[{"href":"\/api\/v1\/content\/articles\/?slug=article-4"},{"href":"\/api\/v1\/content\/articles\/"}]}},"position":3,"sticky":false,"enabled":true,"_links":{"list":{"href":"\/api\/v1\/content\/lists\/1"},"item":{"href":"\/api\/v1\/content\/lists\/1\/items\/4"}}}]}}', true), $content);
    }
    ...
    public function testGetSingleContentListItem()
    {
        ...
        self::assertArraySubset(json_decode('{"id":1,"content":{"id":1,"title":"article1","body":"art1","slug":"article-1","publishedAt":null,"status":"published","route":null,"templateName":null,"publishStartDate":null,"publishEndDate":null,"isPublishable":true,"metadata":null,"media":[],"lead":null,"_links":{"self":{"href":"\/api\/v1\/content\/articles\/article-1"},"online":[{"href":"\/api\/v1\/content\/articles\/?slug=article-1"},{"href":"\/api\/v1\/content\/articles\/"}]}},"position":0,"sticky":true,"enabled":true,"_links":{"list":{"href":"\/api\/v1\/content\/lists\/1"},"item":{"href":"\/api\/v1\/content\/lists\/1\/items\/1"}}}', true), $content);
    }
