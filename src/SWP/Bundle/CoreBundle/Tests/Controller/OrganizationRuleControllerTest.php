...
class OrganizationRuleControllerTest extends WebTestCase
{
    ...
    public function testGetSingleOrganizationRuleApi()
    {
        ...
        $data = $client->getResponse()->getContent();
        $expected = '{"id":1,"expression":"package.getLocated() matches \"\/Sydney\/\"","priority":1,"configuration":{"destinations":[{"tenant":"123abc","route":3}]},"description":null,"name":null,"_links":{"self":{"href":"\/api\/v1\/rules\/1"}}}';
    ...
    public function testUpdateSingleOrganizationRuleApi()
    {
        ...
        $data = $client->getResponse()->getContent();
        $expected = '{"id":1,"expression":"package.getLocated() matches \"\/Sydney\/\"","priority":11,"configuration":{"destinations":[{"tenant":"123abc","route":5}]},"description":"desc","name":"name","_links":{"self":{"href":"\/api\/v1\/rules\/1"}}}';
