...
use SWP\Bundle\CoreBundle\DependencyInjection\Compiler\OverrideContentBundleMediaLoaderPass;
...
class SWPCoreBundle extends Bundle
{
    ...
    public function build(ContainerBuilder $container)
    {
        ...
        $container->addCompilerPass(new OverrideContentBundleMediaLoaderPass());
    }
