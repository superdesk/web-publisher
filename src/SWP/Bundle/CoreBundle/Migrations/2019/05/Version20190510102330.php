 ...
 */
final class Version20190510102330 extends AbstractMigration
{
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE swp_publish_destination ADD CONSTRAINT FK_8C71004A34ECB4E6 FOREIGN KEY (route_id) REFERENCES swp_route (id) ON DELETE SET NULL NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE swp_package_preview_token DROP CONSTRAINT FK_AD1CA87234ECB4E6');
        $this->addSql('ALTER TABLE swp_package_preview_token ADD CONSTRAINT FK_AD1CA87234ECB4E6 FOREIGN KEY (route_id) REFERENCES swp_route (id) ON DELETE SET NULL NOT DEFERRABLE INITIALLY IMMEDIATE');
    }
