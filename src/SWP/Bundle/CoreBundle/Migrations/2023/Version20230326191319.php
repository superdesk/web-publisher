...
final class Version20230326191319 extends AbstractMigration
{
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE swp_user ADD COLUMN IF NOT EXISTS enabled bool NOT NULL;'); //fixing potentially not executing earlier migrations - swp_user.enabled should exist alongside is_verified
