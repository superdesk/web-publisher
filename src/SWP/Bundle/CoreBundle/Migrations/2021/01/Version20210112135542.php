...
final class Version20210112135542 extends AbstractMigration implements ContainerAwareInterface
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(
            'ALTER TABLE swp_article_extra ADD CONSTRAINT IF NOT EXISTS FK_9E61B3177294869C FOREIGN KEY (article_id) REFERENCES swp_article (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE'
        );
    }
