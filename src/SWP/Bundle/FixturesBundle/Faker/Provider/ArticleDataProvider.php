...
final class ArticleDataProvider extends BaseProvider
{
    ...
    public function __construct(Generator $generator, RepositoryInterface $keywordRepository, KeywordFactoryInterface $keywordFactory)
    {
    ...
    public function articleKeywords(): Collection
    {
        $keywords = [
            'Big city',
            'traffic',
        ...
        foreach ($keywords as $key => $keyword) {
            if (null !== ($persistedKeyword = $this->keywordRepository->findOneBy(['name' => $keyword]))) {
                $keywords[$key] = $persistedKeyword;
            } else {
