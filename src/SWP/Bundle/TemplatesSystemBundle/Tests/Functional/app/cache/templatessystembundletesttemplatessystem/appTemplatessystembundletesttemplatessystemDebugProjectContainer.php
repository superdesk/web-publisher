...
/**
 * appTemplatessystembundletesttemplatessystemDebugProjectContainer.
 *
 * This class has been auto-generated
 * by the Symfony Dependency Injection Component.
 */
class appTemplatessystembundletesttemplatessystemDebugProjectContainer extends Container
{
    private $parameters;
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'doctrine_cache.providers.main_cache' => 'getDoctrineCache_Providers_MainCacheService',
            ...
            'monolog.handler.test' => 'getMonolog_Handler_TestService',
            ...
            'swp_template_engine.data_collector.context_collector' => 'getSwpTemplateEngine_DataCollector_ContextCollectorService',
            'swp_template_engine_container' => 'getSwpTemplateEngineContainerService',
            'swp_template_engine_context' => 'getSwpTemplateEngineContextService',
            'swp_template_engine_context.factory.meta_factory' => 'getSwpTemplateEngineContext_Factory_MetaFactoryService',
            'swp_template_engine_context_listener' => 'getSwpTemplateEngineContextListenerService',
            'swp_template_engine_context_reader' => 'getSwpTemplateEngineContextReaderService',
            'swp_template_engine_loader_chain' => 'getSwpTemplateEngineLoaderChainService',
        ...
        $this->aliases = array(
            'context' => 'swp_template_engine_context',
    ...
    protected function getDebug_EventDispatcherService()
    {
        ...
        $instance->addListenerService('kernel.controller', array(0 => 'swp_template_engine_context_listener', 1 => 'onKernelController'), 0);
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_sqlite', 'memory' => true, 'charset' => 'UTF8', 'host' => 'localhost', 'port' => NULL, 'user' => 'root', 'password' => NULL, 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_47fc9fd2ecdb0d3491f53c1da9605214ccd974911c690c0803a6802b658d228a');
    ...
    /**
     * Gets the 'doctrine_cache.providers.main_cache' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Doctrine\Common\Cache\ArrayCache A Doctrine\Common\Cache\ArrayCache instance
     */
    protected function getDoctrineCache_Providers_MainCacheService()
    {
        $this->services['doctrine_cache.providers.main_cache'] = $instance = new \Doctrine\Common\Cache\ArrayCache();

        $instance->setNamespace('templates_engine');
    ...
    {
        return $this->services['jms_serializer.datetime_handler'] = new \JMS\Serializer\Handler\DateHandler('Y-m-d\\TH:i:sO', 'Europe/Warsaw', true);
    }
    ...
    {
        $a = new \Metadata\Driver\FileLocator(array('Symfony\\Bundle\\FrameworkBundle' => ($this->targetDirs[5].'/vendor/symfony/framework-bundle/Resources/config/serializer'), 'Sensio\\Bundle\\FrameworkExtraBundle' => ($this->targetDirs[5].'/vendor/sensio/framework-extra-bundle/Resources/config/serializer'), 'Doctrine\\Bundle\\DoctrineBundle' => ($this->targetDirs[5].'/vendor/doctrine/doctrine-bundle/Resources/config/serializer'), 'JMS\\SerializerBundle' => ($this->targetDirs[5].'/vendor/jms/serializer-bundle/JMS/SerializerBundle/Resources/config/serializer'), 'Doctrine\\Bundle\\DoctrineCacheBundle' => ($this->targetDirs[5].'/vendor/doctrine/doctrine-cache-bundle/Resources/config/serializer'), 'Symfony\\Bundle\\MonologBundle' => ($this->targetDirs[5].'/vendor/symfony/monolog-bundle/Resources/config/serializer'), 'SWP\\Bundle\\TemplatesSystemBundle' => ($this->targetDirs[5].'/Resources/config/serializer')));
    ...
    protected function getLoggerService()
    {
        ...
        $instance->pushHandler($this->get('monolog.handler.test'));

        return $instance;
    }

    /**
     * Gets the 'monolog.handler.test' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Monolog\Handler\TestHandler A Monolog\Handler\TestHandler instance
     */
    protected function getMonolog_Handler_TestService()
    {
        return $this->services['monolog.handler.test'] = new \Monolog\Handler\TestHandler(100, true);
    }
    ...
    {
        $this->services['router'] = $instance = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, ($this->targetDirs[2].'/TemplatesSystem/routing.yml'), array('cache_dir' => __DIR__, 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appTemplatessystembundletesttemplatessystemDebugProjectContainerUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appTemplatessystembundletesttemplatessystemDebugProjectContainerUrlMatcher', 'strict_requirements' => true), $this->get('router.request_context', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('monolog.logger.router', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    ...
    {
        return $this->services['sensio_framework_extra.security.listener'] = new \Sensio\Bundle\FrameworkExtraBundle\EventListener\SecurityListener(NULL, NULL, NULL, NULL, NULL, NULL);
    }
    ...
    /**
     * Gets the 'swp_template_engine.data_collector.context_collector' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \SWP\Bundle\TemplatesSystemBundle\DataCollector\ContextDataCollector A SWP\Bundle\TemplatesSystemBundle\DataCollector\ContextDataCollector instance
     */
    protected function getSwpTemplateEngine_DataCollector_ContextCollectorService()
    {
        return $this->services['swp_template_engine.data_collector.context_collector'] = new \SWP\Bundle\TemplatesSystemBundle\DataCollector\ContextDataCollector($this->get('swp_template_engine_context'));
    }

    /**
     * Gets the 'swp_template_engine_container' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \SWP\Bundle\TemplatesSystemBundle\Service\ContainerService A SWP\Bundle\TemplatesSystemBundle\Service\ContainerService instance
     */
    protected function getSwpTemplateEngineContainerService()
    {
        return $this->services['swp_template_engine_container'] = new \SWP\Bundle\TemplatesSystemBundle\Service\ContainerService($this->get('doctrine'), $this->get('debug.event_dispatcher'), $this, __DIR__, true);
    }

    /**
     * Gets the 'swp_template_engine_context' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \SWP\Component\TemplatesSystem\Gimme\Context\Context A SWP\Component\TemplatesSystem\Gimme\Context\Context instance
     */
    protected function getSwpTemplateEngineContextService()
    {
        return $this->services['swp_template_engine_context'] = new \SWP\Component\TemplatesSystem\Gimme\Context\Context($this->get('doctrine_cache.providers.main_cache'), ($this->targetDirs[2].'/Resources/meta'));
    }

    /**
     * Gets the 'swp_template_engine_context.factory.meta_factory' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \SWP\Component\TemplatesSystem\Gimme\Factory\MetaFactory A SWP\Component\TemplatesSystem\Gimme\Factory\MetaFactory instance
     */
    protected function getSwpTemplateEngineContext_Factory_MetaFactoryService()
    {
        return $this->services['swp_template_engine_context.factory.meta_factory'] = new \SWP\Component\TemplatesSystem\Gimme\Factory\MetaFactory($this->get('swp_template_engine_context'));
    }

    /**
     * Gets the 'swp_template_engine_context_listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \SWP\Bundle\TemplatesSystemBundle\EventListener\ContextListener A SWP\Bundle\TemplatesSystemBundle\EventListener\ContextListener instance
     */
    protected function getSwpTemplateEngineContextListenerService()
    {
        return $this->services['swp_template_engine_context_listener'] = new \SWP\Bundle\TemplatesSystemBundle\EventListener\ContextListener($this->get('swp_template_engine_context_reader'), $this->get('swp_template_engine_context'));
    }

    /**
     * Gets the 'swp_template_engine_context_reader' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \SWP\Bundle\TemplatesSystemBundle\Annotation\ContextReader A SWP\Bundle\TemplatesSystemBundle\Annotation\ContextReader instance
     */
    protected function getSwpTemplateEngineContextReaderService()
    {
        return $this->services['swp_template_engine_context_reader'] = new \SWP\Bundle\TemplatesSystemBundle\Annotation\ContextReader($this->get('annotation_reader'));
    }

    /**
     * Gets the 'swp_template_engine_loader_chain' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \SWP\Component\TemplatesSystem\Gimme\Loader\ChainLoader A SWP\Component\TemplatesSystem\Gimme\Loader\ChainLoader instance
     */
    protected function getSwpTemplateEngineLoaderChainService()
    {
        return $this->services['swp_template_engine_loader_chain'] = new \SWP\Component\TemplatesSystem\Gimme\Loader\ChainLoader();
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('Three can keep a secret, if two of them are dead.');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.environment' => 'templatessystembundletesttemplatessystem',
            'kernel.debug' => true,
            'kernel.name' => 'app',
            ...
            'kernel.bundles' => array(
                ...
                'SWPTemplatesSystemBundle' => 'SWP\\Bundle\\TemplatesSystemBundle\\SWPTemplatesSystemBundle',
            ),
            'kernel.charset' => 'UTF-8',
            'kernel.container_class' => 'appTemplatessystembundletesttemplatessystemDebugProjectContainer',
            'kernel.test_case' => 'TemplatesSystem',
            'domain' => 'localhost',
            ...
            'router.options.matcher.cache_class' => 'appTemplatessystembundletesttemplatessystemDebugProjectContainerUrlMatcher',
            'router.options.generator.cache_class' => 'appTemplatessystembundletesttemplatessystemDebugProjectContainerUrlGenerator',
            'router_listener.class' => 'Symfony\\Component\\HttpKernel\\EventListener\\RouterListener',
            'router.request_context.host' => 'localhost',
            'router.request_context.scheme' => 'http',
            'router.request_context.base_url' => '',
            'router.resource' => ($this->targetDirs[2].'/TemplatesSystem/routing.yml'),
            'router.cache_class_prefix' => 'appTemplatessystembundletesttemplatessystemDebugProjectContainer',
            ...
            'debug.container.dump' => (__DIR__.'/appTemplatessystembundletesttemplatessystemDebugProjectContainer.xml'),
