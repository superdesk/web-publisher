...
class NinjsValidator extends JsonValidator
{
  ...
  "$schema": "http://json-schema.org/draft-03/schema#",
	"id" : "https://github.com/superdesk/superdesk-core/blob/master/docs/superdesk-ninjs-schema.json#",
	"type" : "object",
	...
	"properties" : {
		...
		"associations" : {
			...
			"additionalProperties" : false,
			"patternProperties" : {
				"^[a-zA-Z0-9]+[a-zA-Z0-9-]*" :  { "$ref": "https://github.com/superdesk/superdesk-core/blob/master/docs/superdesk-ninjs-schema.json#" }
			}
		},
		"extra" : {
