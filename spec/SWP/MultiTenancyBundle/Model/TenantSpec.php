 ...
 */
namespace spec\SWP\MultiTenancyBundle\Model;
...
class TenantSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('SWP\MultiTenancyBundle\Model\Tenant');
    }

    public function it_implements_tenant_interface()
    {
        $this->shouldImplement('SWP\MultiTenancyBundle\Model\TenantInterface');
    }
