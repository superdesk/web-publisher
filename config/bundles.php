...
return [
    ...
    SWP\Bundle\RevisionBundle\SWPRevisionBundle::class => ['all' => true],
    ...
    //BehatExtension\DoctrineDataFixturesExtension\Bundle\BehatDoctrineDataFixturesExtensionBundle::class => ['dev' => true, 'test' => true],
