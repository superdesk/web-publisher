 ...
 */
final class Version20180807073002 extends AbstractMigration
{
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE swp_slideshow_items (slideshow_id INT NOT NULL, item_id INT NOT NULL, PRIMARY KEY(slideshow_id, item_id))');
        $this->addSql('CREATE INDEX IDX_394CE77C8B14E343 ON swp_slideshow_items (slideshow_id)');
        $this->addSql('CREATE INDEX IDX_394CE77C126F525E ON swp_slideshow_items (item_id)');
        ...
        $this->addSql('ALTER TABLE swp_slideshow_items ADD CONSTRAINT FK_394CE77C8B14E343 FOREIGN KEY (slideshow_id) REFERENCES swp_slideshow (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE swp_slideshow_items ADD CONSTRAINT FK_394CE77C126F525E FOREIGN KEY (item_id) REFERENCES swp_article_media (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE swp_slideshow_items DROP CONSTRAINT FK_394CE77C8B14E343');
        ...
        $this->addSql('DROP TABLE swp_slideshow_items');
